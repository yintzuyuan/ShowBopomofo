...
#import "ShowHanPhonetics.h"

// Debug logging macro
#ifdef DEBUG
	#define DLog(fmt, ...) NSLog((@"[ShowHanPhonetics] %s " fmt), __PRETTY_FUNCTION__, ##__VA_ARGS__)
#else
...
// UserDefaults key
static NSString * const kPhoneticDisplayModeKey = @"com.YinTzuYuan.ShowHanPhonetics.displayMode";
static NSString * const kOldPhoneticDisplayModeKeys[] = {
	@"com.YinTzuYuan.ShowHanziPhonetics.displayMode",
	@"com.YinTzuYuan.ShowChinesePhonetics.displayMode",
};

@implementation ShowHanPhonetics {
